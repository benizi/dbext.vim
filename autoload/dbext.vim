...
function! s:DB_getDefault(name)
    ...
    elseif a:name ==# "SQLITE_SQL_Top_pat"      |return (exists("g:dbext_default_SQLITE_SQL_Top_pat")?g:dbext_default_SQLITE_SQL_Top_pat.'':'\(.*\)')
    elseif a:name ==# "SQLITE_SQL_Top_sub"      |return (exists("g:dbext_default_SQLITE_SQL_Top_sub")?g:dbext_default_SQLITE_SQL_Top_sub.'':'\1 LIMIT @dbext_topX ')
